<template>
    ...
    <template>
        <v-row>
            ...
            <v-card class="pa-1">
                <v-card-title>
                <span class="headline" style="white-space: nowrap;">Registration Form</span>
                </v-card-title>
                <span v-if="error" class="red--text ml-2">This email already registered</span>
                ...
                <v-card-text>
                    ...
                    <v-form  ref="form" v-model="valid" lazy-validation >
                        ...
                        <v-col cols="12">
                            <v-text-field label="Email confirmation*"
                        ...
                        <v-col  cols="12">
                            <v-select
                                ...
                                item-text="Activite_en"
                                item-value="Activite_en"
                                v-model="domaine"
                                required
                                :rules="domaineRule"
                            ></v-select>
                    ...
                    <v-container v-else>
                        ...
                        Dear participant,<br>
                        You have successfully registered for the Smart City Casablanca Symposium.<br>
                        To access the event platform, please check your e-mail box and spam if applicable.<br>
                        Thank you.
                        </v-alert>
                    </v-container>
                </v-card-text>
   ...
   data () {
      return {
        ...
        emailconfermRules: [ 
            ...
            v => v == this.email  || 'Email must be valid'
        ],

        allRule: [v => !!v || 'This field is required',],
    ...
    methods: {
        validate () {
         if(this.$refs.form.validate()){
                ...
                this.axios({
                    method: 'post',
                    url: 'https://sccs2021en.ascreacongres.ma/api/inscrit',
                    data: {
                        email:this.email ,
